...
function Stake() {
  ...
  return (
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        <title key="title">OracleSwap | Stake</title>
        <meta
          key="description"
          name="description"
          content="Stake OS in return for xOS, an interest bearing and fungible ERC20 token designed to share revenue generated by all OS products."
        />
          ...
          <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
            <div className="flex max-w-lg">
              <div className="self-end mb-3 text-lg font-bold md:text-2xl text-high-emphesis md:mb-7">
                {i18n._(t`Maximize yield by staking OS for xOS`)}
              </div>
            ...
            <div className="max-w-lg pr-3 mb-2 text-sm leading-5 text-gray-500 md:text-base md:mb-4 md:pr-0">
              {i18n._(
                t`For every swap on the exchange, 0.035% of the swap fees are distributed as OS proportional to your share of the OracleFoundry. When your OS is staked into the OracleFoundry, you receive xOS. Your xOS is continuously compounding, when you unstake you will receive all the originally deposited OS and any additional from fees`
              )}
            </div>
            {/* <div className="flex">
          ...
          <div className="w-full h-full max-w-xl md:ml-6 md:block md:w-72">
            <div className="flex flex-col flex-grow w-full px-4 pt-4 pb-3 rounded bg-dark-900 md:px-5 md:pt-5 md:pb-7">
              <div className="flex flex-col flex-wrap">
                {/* <img src={xORACLEFImage.src} alt="xOS sign" width="100%" height="100%" /> */}
                <div className="flex flex-row mb-3">
                  ...
                  <QuestionHelper
                    ...
                    text={`BE AWARE OF GAS SPENDING WHEN CALLING THE DIST/BURN! The OS Distributor receives DEX swap fees from the feeToo address of the OracleSwapFactory Contract. The fees are in the form of OLP Tokens. OS Token holders can publicly call the Distribute function to convert the OLP Tokens to OS and distribute them. 70% of the OS is sent to the OracleFoundry/Stakers, 10% is sent to the treasury, 10% is sent to Prophet Sacrifice, and 10% is sent to the dead address. If the OracleTreasury address is zero then the 10% is sent to Prophet Sarifice.`}
                  />
                </div>
                ...
                <div className="flex flex-col flex-grow text-base md:mb-3">
                  ...
                  <p>
                    <span>&#127789; </span> OS To Stakers: <span>{foundry?.toSignificant(6)}</span>
                    {/* &#127835; */}
                  </p>
                  <p>
                    <span>&#128293;</span> OS Burned: <span>{burned?.toSignificant(6)}</span>
                  </p>
                  <p>
                    <span>&#128293;</span> OS To Sacrifice: <span>{prophet?.toSignificant(6)}</span>
                  </p>
                  <p>
                    <span>&#127974;</span> OS To Treasury: <span>{treasury?.toSignificant(6)}</span>
                  </p>
              ...
              <div className="w-full max-w-xl px-3 pt-2 pb-6 rounded bg-dark-900 md:pb-9 md:pt-4 md:px-8">
                ...
                <div className="flex items-center justify-between w-full mt-6">
                  <p className="font-bold text-large md:text-2xl text-high-emphesis">
                    {activeTab === 0 ? i18n._(t`Stake OS`) : i18n._(t`Unstake`)}
                  </p>
                  <div className="border-gradient-r-pink-red-light-brown-dark-pink-red border-transparent border-solid border rounded-3xl px-4 md:px-3.5 py-1.5 md:py-0.5 text-high-emphesis text-xs font-medium md:text-base md:font-normal">
                    {`1 xOS = ${Number(ratio)?.toFixed(4)} OS`}
                  </div>
                </div>
                ...
                <div className="relative w-full h-0 pointer-events-none bottom-14">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        {`${input ? input : '0'} ${activeTab === 0 ? '' : 'x'}OS`}
                      </p>
                    </div>
                ...
                <div className="flex flex-col flex-grow md:mb-14">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">xOS</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center ml-8 space-x-4 md:ml-0">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">OS</p>
                    </div>
                  </div>
                </div>
