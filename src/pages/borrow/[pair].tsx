  ...
  return (
    <PairLayout>
      <Head>
        ...
        <title>{i18n._(t`Borrow ${pair?.asset?.symbol}-${pair?.collateral?.symbol}`)} | OwlSwap</title>
        <meta
          key="description"
          name="description"
          /* @ts-ignore TYPE NEEDS FIXING */
          content={`Borrow ${pair?.asset?.symbol} against ${pair?.collateral?.symbol} collateral on Kashi by OwlSwap`}
        />
        <meta
