...
function ProStaking() {
  ...
  return (
    <Container id="prostaking-page" className="py-4 md:py-8 lg:py-12" maxWidth="5xl">
      <Head>
        <title key="title">OracleSwap | ProStaking</title>
          ...
          <div className="flex flex-wrap top-area">
            <div className="w-full md:w-[calc(100%-300px)] md:pr-4">
              ...
              <div className="self-end text-lg font-bold md:text-2xl text-high-emphesis md:mb-3">
                {i18n._(t`The OS/Prophet Multi-Staking`)}
              </div>

              <div className="mb-4 text-sm font-normal content md:text-base">
                <p>
                  This is where The Oracles and PRO unite.
                  <br /> Stake PRO, THE OS NFTs, & xOS to harvest the rewards generated by the OS Factory,
                  OS Distributor, Prophet Sacrifice & more.
                  <br /> This staking system distributes a variety of tokens and token pairs. Some tokens are PRO,
                  xOS, OS OLPs and more. Main examples of OLPs are PRO pairs like PRO/SGB, PRO/OS. OLPs from
              ...
              <div className="flex flex-wrap p-5 rounded-md global-stat bg-dark-800">
                <div className="w-full sm:w-1/2">
                  ...
                  <p>{`Total OS NFTs Locked:  ${totalNFTCount ? totalNFTCount : ''}`}</p>
                  <p>{`Total XOS Locked:  ${totalxOracleAmount ? totalxOracleAmount.toSignificant(6) : ''}`}</p>
              ...
              <div className="p-5 mt-3 mb-1 text-sm font-bold bg-red-500 rounded-md warning md:text-base">
                <p>
                  ...
                  break your timelocks you will lose 50% of your PRO/XOS stake. It is not recommended to lock up all of your holdings. Use at your own risk.
                </p>
              </div>
            ...
            <div className="w-full md:w-[300px] mt-2 md:mt-0 bg-dark-900 rounded-3xl p-5">
              ...
              <p className='text-sm font-normal md:text-base'>
                ...
                share of the pool.
                <br />
                -To add OS NFTs you must stake the minimum amount of PRO one time and you must also stake the minimum xOS amount per NFT.
                <br />
                -Consequences for breaking the spacetime barrier: Forfeit 50% of your locked PRO/xOS. Half of this
                PRO/xOS gets sent to the void. Half goes back to the Loyal Stakers.
                <br />
